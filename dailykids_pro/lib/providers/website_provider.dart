...
class WebsiteProvider extends ChangeNotifier {
  ...
  void _initMockData() {
    ...
    _testimonials = [
      Testimonial(id: 'tst_1', parentName: 'Nimal Perera', childName: 'Amaya', quote: 'DailyKids has been a wonderful experience for our daughter. The teachers are caring and communicative.', rating: 5.0),
