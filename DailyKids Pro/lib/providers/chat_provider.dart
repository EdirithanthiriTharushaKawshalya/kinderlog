  ...
  void _initMockData() {
    _threads = [
      ChatThread(
        ...
        messages: [
          ChatMessage(
            id: 'msg_01', threadId: 'chat_01', senderId: 'user_parent_1',
          ...
          ChatMessage(
            id: 'msg_03', threadId: 'chat_01', senderId: 'user_parent_1',
            senderName: 'John Smith', senderRole: 'parent',
      ...
      ChatThread(
        ...
        messages: [
          ChatMessage(
            id: 'msg_04', threadId: 'chat_02', senderId: 'user_parent_2',
