...
class AdmissionReviewScreen extends StatefulWidget {
  const AdmissionReviewScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Consumer<AdmissionProvider>(
      builder: (context, admission, _) {
        ...
        return Scaffold(
          appBar: AppBar(title: const Text('Admission Review')),
          body: Column(
            children: [
              // Filter tabs
              Container(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              controller: noteCtrl,
              decoration: const InputDecoration(labelText: 'Reviewer note (optional)', hintText: 'e.g. Welcome to KinderLog!'),
              maxLines: 2,
            ),
          ],
        ),
